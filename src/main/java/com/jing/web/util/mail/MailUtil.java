...
public class MailUtil {
	 ...
	 * @author bxy-jing
	 * @param mailInfo
	 * @param start 第几封邮件开始，负值为倒数第几封开始
	 * @param count 查询数量
	 * @return
	...
	public static List<Mail> getMails(MailInfo mailInfo,int start,int count) throws MessagingException, IOException{
		showDelay();
...
//		mailInfo.setUsername("290173092@qq.com");
//		mailInfo.setPassword("333");
//		mailInfo.setPop3Host("pop.qq.com");
...
//		mailInfo.setUsername("jingshouyan@vrvmail.com.cn");
//		mailInfo.setPassword("123");
//		mailInfo.setPop3Host("www.vrvmail.com.cn");
//		mailInfo.setPop3Port(110);
		...
		try {
				List<Mail> mails = getMails(mailInfo,1,10);
				for(Mail mail:mails){
