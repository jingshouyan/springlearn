...
public class ModelUtil {
	...
	/**
	 * 
	 * @Title: valueMap @Description: 获取model的值map @param @param
	 * obj @param @return 设定文件 @return Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: setValues @Description: 使用map给model赋值 @param @param
	 * model @param @param map 设定文件 @return void 返回类型 @throws
	 */
